...
public class WeatherStructureMod implements ModInitializer {
    ...
    // Per-world countdown timers (ticks remaining until next weather change)
    ...
    public void onInitialize() {
        LOGGER.info("[WeatherStructureMod] Initializing — Dynamic Weather & Structure Boost active.");
        ServerTickEvents.END_WORLD_TICK.register(this::onWorldTick);
    }

    private void onWorldTick(ServerWorld world) {
        // Only affect the Overworld — Nether/End have no weather
